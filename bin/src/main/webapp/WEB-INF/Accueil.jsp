        ...
        <div class="container">
          <div class="banner_content row">
            <div class="col-lg-12">
              ...
              <a class="main_btn mt-40" href="#">Voir notre magasin</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-6">
            <div class="new_product">
              ...
              <div class="product-img">
                <img class="img-fluid" src="inc/img/product/new-product/new-product1.png" alt="" />
              </div>
              <h4>$120.70</h4>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="single-product">
                  <div class="product-img">
                    <img class="img-fluid w-100" src="inc/img/product/new-product/n1.jpg" alt="" />
                    <div class="p_icon">
                      <a href="#">
                        <i class="ti-eye"></i>
                      </a>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="single-product">
                  <div class="product-img">
                    <img class="img-fluid w-100" src="inc/img/product/new-product/n2.jpg" alt="" />
                    <div class="p_icon">
                      <a href="#">
                        <i class="ti-eye"></i>
                      </a>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="single-product">
                  <div class="product-img">
                    <img class="img-fluid w-100" src="inc/img/product/new-product/n3.jpg" alt="" />
                    <div class="p_icon">
                      <a href="#">
                        <i class="ti-eye"></i>
                      </a>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="single-product">
                  <div class="product-img">
                    <img class="img-fluid w-100" src="inc/img/product/new-product/n4.jpg" alt="" />
                    <div class="p_icon">
                      <a href="#">
                        <i class="ti-eye"></i>
                      </a>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="inc/img/product/inspired-product/i1.jpg" alt="" />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="inc/img/product/inspired-product/i2.jpg" alt="" />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="inc/img/product/inspired-product/i3.jpg" alt="" />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="inc/img/product/inspired-product/i4.jpg" alt="" />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="inc/img/product/inspired-product/i5.jpg" alt="" />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="inc/img/product/inspired-product/i6.jpg" alt="" />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="inc/img/product/inspired-product/i7.jpg" alt="" />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="inc/img/product/inspired-product/i8.jpg" alt="" />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
      ...
      <div class="container">
        ...
        <div class="footer-bottom row align-items-center">
          <p class="footer-text m-0 col-lg-8 col-md-12">
            ...
            Copyright &copy;
            <script>document.write(new Date().getFullYear());</script> All rights reserved | This template is modified,
            made with
